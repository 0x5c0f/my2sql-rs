...
#
# 导出的函数（T7 接口清单）：
#   p3e2e_container_start <ver> [suffix]   起容器+等健康；置全局
...
p3e2e_container_start() { # <5.6|5.7|8.0|8.4> [name-suffix，缺省 $$]
  local ver=${1:?usage: p3e2e_container_start <ver> [suffix]}
  local sfx=${2:-$$}
